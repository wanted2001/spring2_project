...
<div class="container-md">
	...
	<form action="/member/modify" method="post">
		...
		<div class="mb-3">
			<label for="i" class="form-label">REG_DATE</label> <input type="text"
				class="form-control" name="reg_date" id="r" value ="${ses.reg_date }" readonly="readonly">
		</div>
		<div class="mb-3">
			<label for="i" class="form-label">LAST_LOGIN</label> <input type="text"
		...
		<a href="/member/delete"><button type="button" class="btn btn-success">DELETE</button></a>
	</form>
</div>
